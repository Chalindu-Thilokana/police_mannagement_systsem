        ...
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                  <li>
                    <a href="#" class="block py-2 pr-4 pl-3 text-blue-900 border-b border-blue-900 hover:text-blue-600 hover:bg-blue-950 lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-blue-900 dark:hover:text-blue-600 dark:hover:bg-blue-700 lg:dark:hover:bg-transparent dark:border-blue-700 active:text-blue-400">Home</a>
                </li>
                  <li>
                  ...
                  <li>
                    <a href="#contact" class="block py-2 pr-4 pl-3 text-blue-900 border-b border-blue-900 hover:text-blue-600 hover:bg-blue-950 lg:hover:bg-transparent lg:border-0 lg:p-0 dark:text-blue-900 dark:hover:text-blue-600 dark:hover:bg-blue-700 lg:dark:hover:bg-transparent dark:border-blue-700 active:text-blue-400">Contact Us</a>
                  </li>
